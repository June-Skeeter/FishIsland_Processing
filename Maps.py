...
def Intro_Map(ax,Major_font,Minor_font,clipped = True):
    ...
    ax1.scatter(spots.iloc[0]['X'],spots.iloc[0]['Y'],label=spots.iloc[0]['Site'],s=80,marker='*',color='red')
    ax1.scatter(spots.iloc[1]['X'],spots.iloc[1]['Y'],label=spots.iloc[1]['Site'],s=80,marker='*',color='blue')
