...
#         
    ...
    def Fco2_Fill(self,PPFD,Temp,p0 =(0.00699139,  3.08946606,  0.83363605,  0.57199121,  2.01299858)):#,p0 =(0.07456007,30.82786468,0.32274278,0.63617274,1.68500993)):# (0.00716274,1.52597427,1,0.5,0.01)):
        ...
        for i in Dataset[Key].unique():
            ...
            # Subset = Data.loc[Data[PPFD]<10]
            # try:
            # if i > 7:
            #     popt3,pcov2 = curve_fit(self.ER,Subset[Temp].values,Subset.fco2.values)
            #     Data['ER2'] = self.ER(Data[Temp],popt3[0],popt3[1],popt3[2])
            #     FillData['ER2'] = self.ER(FillData[Temp],popt3[0],popt3[1],popt3[2])
            #     self.Data.loc[self.Data[Key]==i,'ER2'] = FillData['ER2']

            #     popt2,pcov2 = curve_fit(self.Hyperbola,Data[PPFD].values,(Data.fco2.values-Data['ER2']))
            #     self.popts2[str(i)]=popt2
            #     FillData['GPP2'] = self.Hyperbola(FillData[PPFD],popt2[0],popt2[1])
            #     self.Data.loc[self.Data[Key]==i,'GPP2'] = FillData['GPP2']
            # except:
            #     print('No Night')
